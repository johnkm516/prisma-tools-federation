...
export default gql`
  ...
  type AggregateUser @key(fields: "id") @key(fields: "email") {
  ...
  type UserCountAggregateOutputType @key(fields: "id") @key(fields: "email") {
    id: Int!
    createdAt: Int!
    username: Int!
    password: Int!
  ...
  type UserAvgAggregateOutputType @key(fields: "id") @key(fields: "email") {
    id: Float
  }

  type UserSumAggregateOutputType @key(fields: "id") @key(fields: "email") {
    id: Int
  }
